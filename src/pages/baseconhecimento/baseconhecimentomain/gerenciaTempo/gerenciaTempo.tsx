...
export default  function GerenciaTempo(){
...
<div className={StyleGerenciaTempo.backgroundpag}>
   <section className={StyleGerenciaTempo.container}>
      <div className={StyleGerenciaTempo.text}>
        <h1>Técnicas para você gerenciar seu tempo</h1>
<p>
  Já sentiu que o dia passa rápido demais e, mesmo assim, parece que nada foi concluído? <br />
  Se organizar pode parecer difícil no começo, mas com algumas técnicas simples, tudo fica mais leve.
</p>
</div>
</section>

<article className={StyleGerenciaTempo.containertext}>
<div className={StyleGerenciaTempo.textcontent2}>
  <p>
    Durante a vida acadêmica, é comum lidar com provas, trabalhos, estudos, vida pessoal e até emprego ao mesmo tempo.
    Com tantas responsabilidades, a falta de organização pode gerar estresse, atrasos e sensação de sobrecarga.
    <br /><br />
    Gerenciar o tempo não significa fazer tudo ao mesmo tempo, mas sim aprender a priorizar, planejar e usar melhor cada momento do seu dia.
    E calma: estamos aqui para te ajudar com isso!
  </p>
...
<div className={StyleGerenciaTempo.section2}>
  ...
  <p>
    Gerenciar o tempo é uma habilidade que se constrói com prática e paciência.
    Nem todos os dias serão perfeitos — e tudo bem.
    <br />
    <span className="fw-bold">Organização não é rigidez, é cuidado com você mesma.</span>
    Comece aos poucos e perceba como sua rotina pode se tornar mais leve e produtiva 🚀
  </p>
</div>
</section>


    <section className={StyleGerenciaTempo.containersectiontextarea}>
      <div className={StyleGerenciaTempo.sectiontextarea}>
        <h1>Gostou desse conteudo?</h1>
<br />
        <div className={StyleGerenciaTempo.buttomcunstomtext}>
          <MyButton></MyButton>
        </div>
   ...
   <section className={StyleGerenciaTempo.containersectiontextarea}>
      <div className={StyleGerenciaTempo.sectionwithcite}>
         </div>
       </section>
     </div>
